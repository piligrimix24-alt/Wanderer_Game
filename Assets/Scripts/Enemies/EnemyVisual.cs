...
public class SlimeVisual : MonoBehaviour
{
    ...
    [SerializeField] private bool isBlob;
    [SerializeField] private AudioClip blobAttack;
    ...
    private void _enemyAI_OnEnemyAttack(object sender, System.EventArgs e)
    {
        ...
        if (isBlob)
        {
            AudioManager.Instance.PlaySFX(blobAttack, 0.5f);
        }
        if (isSlime)
        {
            AudioManager.Instance.PlaySFX(slimeAttack);
        }
    }
